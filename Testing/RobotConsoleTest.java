...
class RobotConsoleTest {
    ...
    public void testageOkMsg() throws IOException
    {
        ...
        String[] linesOfOutput = whatWasPrinted.split(System.getProperty("line.separator")); assertEquals("Age ok", linesOfOutput[0]);
    ...
    public void testageNotOkMsg() throws IOException
    {
        ...
        baos.flush();
        String whatWasPrinted = new String(baos.toByteArray());
        String[] linesOfOutput = whatWasPrinted.split( System.getProperty("line.separator")); assertEquals("Error Age too old", linesOfOutput[0]);
    }
